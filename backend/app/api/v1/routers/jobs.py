...
from ....services.job_service import get_job_status, get_active_job_for_document, get_last_job_for_document
...
async def get_job(job_id: str):
    ...
    # Pydantic will coerce ISO strings to datetime where declared
    return data
