...
class RouteFunction(BaseFunction):
    ...
    meta = FunctionMeta(
        ...
        output_schema=OutputSchema(
            ...
            fields=[
                OutputFieldDoc(name="route", type="str",
                              description="Name of the selected route",
                              example="support"),
                ...
                OutputFieldDoc(name="below_threshold", type="bool",
                              ...
                              nullable=True),
                OutputFieldDoc(name="alternatives", type="list",
                              description="Alternative routes with their confidences",
                              nullable=True),
            ],
        ),
        output_variants=[
            OutputVariant(
                ...
                schema=OutputSchema(
                    type="list[dict]",
                    description="List of routing results for each item",
                    fields=[
