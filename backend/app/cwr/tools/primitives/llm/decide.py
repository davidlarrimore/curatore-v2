...
class DecideFunction(BaseFunction):
    ...
    meta = FunctionMeta(
        ...
        input_schema={
            ...
            "properties": {
                "question": {
                    ...
                    "examples": ["Should this opportunity be flagged for review?"],
                },
                "data": {
                    "type": "string",
                ...
                "criteria": {
                    ...
                    "default": None,
                    "examples": ["Flag if value > $1M or involves AI/ML technologies"],
                },
                "system_prompt": {
                    "type": "string",
        ...
        output_schema={
            ...
            "properties": {
                "decision": {"type": "boolean", "description": "The yes/no decision (true=yes, false=no)", "examples": [True]},
                "confidence": {"type": "number", "description": "Confidence score (0.0-1.0)", "examples": [0.92]},
                "reasoning": {"type": "string", "description": "Explanation for the decision", "nullable": True},
            ...
            "variants": [
                {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "decision": {"type": "boolean", "description": "The yes/no decision"},
