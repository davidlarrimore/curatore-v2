"""
Playwright Client for Web Page Rendering.
...
Usage:
    from app.services.playwright_client import playwright_client
...
class PlaywrightClient:
    ...
    async def render_page(
        ...
        while attempt <= retries:
            try:
                response = await self._client.post("/api/v1/render", json=payload)
