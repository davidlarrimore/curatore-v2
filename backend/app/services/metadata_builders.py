...
Usage:
    from app.services.metadata_builders import metadata_builder_registry
...
class AssetSharePointBuilder(MetadataBuilder):
    """Builder for SharePoint-sourced assets."""

    def __init__(self):
        super().__init__(
            source_type="asset_sharepoint",
            namespace="sharepoint",
            display_name="SharePoint Asset",
        )
    ...
    def build_metadata(
        ...
        **kwargs,
        ...
        return {
            ...
            "sharepoint": {
                "path": sm.get("sharepoint_path"),
                "folder": sm.get("sharepoint_folder"),
                "web_url": sm.get("sharepoint_web_url"),
                "created_by": sm.get("created_by"),
                "modified_by": sm.get("modified_by"),
            },
        }


class AssetUploadBuilder(MetadataBuilder):
    """Builder for user-uploaded assets."""

    def __init__(self):
        super().__init__(
            source_type="asset_upload",
            namespace="source",
            display_name="Uploaded Asset",
        )
...
class AssetWebScrapeBuilder(MetadataBuilder):
    """Builder for web-scraped assets."""

    def __init__(self):
        super().__init__(
            source_type="asset_web_scrape",
            namespace="source",
            display_name="Web Scrape Asset",
        )
...
class AssetDefaultBuilder(MetadataBuilder):
    """Fallback builder for assets with unknown source_type."""

    def __init__(self):
        super().__init__(
            source_type="asset_default",
            namespace="source",
            display_name="Asset",
        )
...
def _register_defaults():
    ...
    metadata_builder_registry.register(AssetSharePointBuilder())
    metadata_builder_registry.register(AssetUploadBuilder())
    metadata_builder_registry.register(AssetWebScrapeBuilder())
    metadata_builder_registry.register(AssetDefaultBuilder())
