...
export default function SalesforceContactDetailPage() {
  return (
    <ProtectedRoute>
      <SalesforceContactDetailContent />
    </ProtectedRoute>
  )
}

function SalesforceContactDetailContent() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
            ...
            <Link href="/salesforce/contacts" className="mt-4 inline-block text-cyan-600 dark:text-cyan-400 hover:underline">
              Back to Contacts
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <Link href="/salesforce/contacts" className="hover:text-gray-900 dark:hover:text-white">
            Contacts
          </Link>
          <span>/</span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            ...
            {contact.account_name && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Link
                    href={`/salesforce/accounts/${contact.account_id}`}
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 flex flex-wrap gap-3">
            ...
            {contact.account_id && (
              <Link href={`/salesforce/accounts/${contact.account_id}`}>
                <Button variant="secondary" size="sm" className="gap-2">
