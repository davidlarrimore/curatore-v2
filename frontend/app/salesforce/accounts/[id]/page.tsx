...
export default function SalesforceAccountDetailPage() {
  return (
    <ProtectedRoute>
      <SalesforceAccountDetailContent />
    </ProtectedRoute>
  )
}

function SalesforceAccountDetailContent() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
            ...
            <Link href="/salesforce/accounts" className="mt-4 inline-block text-cyan-600 dark:text-cyan-400 hover:underline">
              Back to Accounts
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <Link href="/salesforce/accounts" className="hover:text-gray-900 dark:hover:text-white">
            Accounts
          </Link>
          <span>/</span>
