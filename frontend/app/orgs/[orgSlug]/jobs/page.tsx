...
/**
 * Organization-scoped job manager page.
 * Shows jobs for the current organization from the URL.
 */
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {filteredJobs.map((job) => {
                    ...
                    return (
                      <tr
                        key={job.run_id}
                        onClick={() => router.push(orgUrl(`/jobs/${job.run_id}`))}
                          ...
                          <div className="min-w-0">
                            <div className="flex items-center gap-2">
                              {job.run_type === 'extraction' && job.asset_id ? (
                                <Link
                                  href={orgUrl(`/assets/${job.asset_id}`)}
