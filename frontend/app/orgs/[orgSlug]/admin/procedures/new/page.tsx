    ...
    loading: () => (
      <div className="bg-white dark:bg-gray-800 rounded-b-lg border border-t-0 border-gray-200 dark:border-gray-700 p-8">
        <div className="flex flex-col items-center justify-center">
          <div className="w-10 h-10 rounded-full border-4 border-gray-200 dark:border-gray-700 border-t-indigo-500 animate-spin" />
...
export default function NewProcedurePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!savedProcedure) {
        router.replace(orgUrl(`/admin/procedures/${saved.slug}/edit`))
      }
    } catch (err: unknown) {
        ...
        <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <button
                onClick={() => router.push(orgUrl('/admin/procedures'))}
