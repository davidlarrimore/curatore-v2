 ...
 * Shows org-specific stats and quick actions.
 */
...
export default function OrgDashboardPage() {
  ...
  const [storageStats] = useState<StorageStats | null>(null)
  ...
  }, [isAuthenticated, token, organization, fetchHealthData, fetchRunStats, fetchStorageHealth, fetchAssetHealth])
  ...
  const healthyCount = healthData?.components
    ...
    : 0
  // totalComponents variable removed as unused
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">
                  {organization?.display_name || 'Dashboard'}
                </h1>
