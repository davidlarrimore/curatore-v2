...
/**
 * Organization-scoped web scrape collections page.
 */
                ...
                {filteredCollections.map((collection) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <Link href={orgUrl(`/syncs/scrape/${collection.id}`)} className="block">
                        <div className="flex items-center gap-3">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        ...
                        {isCrawling(collection.id) && (() => {
                          ...
                          return activeJob ? (
                            <Link
                              href={orgUrl(`/jobs/${activeJob.runId}`)}
                        ...
                        {/* View details link */}
                        <Link
                          href={orgUrl(`/syncs/scrape/${collection.id}`)}
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      try {
        ...
        const errMessage = crawlErr instanceof Error ? crawlErr.message : 'Unknown error'
        setError(`Website added but crawl failed to start: ${errMessage}. You can start it manually.`)
        setLoading(false)
