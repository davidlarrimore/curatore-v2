      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
            ...
            <Link href={orgUrl('/syncs/salesforce/opportunities')} className="mt-4 inline-block text-cyan-600 dark:text-cyan-400 hover:underline">
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <Link href={orgUrl('/syncs/salesforce/opportunities')} className="hover:text-gray-900 dark:hover:text-white">
            Opportunities
          </Link>
          <span>/</span>
            ...
            {opportunity.account_name && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Link
                    href={orgUrl(`/syncs/salesforce/accounts/${opportunity.account_id}`)}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-3">
              {opportunity.linked_sharepoint_folder_id && (
                <Link
                  href={orgUrl(`/syncs/sharepoint/${opportunity.linked_sharepoint_folder_id}`)}
              ...
              {opportunity.linked_sam_solicitation_id && (
                <Link
                  href={orgUrl(`/syncs/sam/solicitations/${opportunity.linked_sam_solicitation_id}`)}
                  className="flex items-center gap-2 text-cyan-600 dark:text-cyan-400 hover:underline"
                >
                  <FileText className="w-4 h-4" />
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          {opportunity.account_id && (
            <Link href={orgUrl(`/syncs/salesforce/accounts/${opportunity.account_id}`)}>
              <Button variant="secondary" className="gap-2">
                <Building2 className="w-4 h-4" />
                View Account
              </Button>
